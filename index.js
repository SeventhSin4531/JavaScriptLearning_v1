...
// const a = "Привет, "
// const b = "мир!"
// const c = a + b /* вот тут собственно и происходит конкатенация строк */
...
// const five = 5
// const result = `Воткните админу ${five} хуёв в жопу`

// console.log(result)

// // с помощью конструкции `${имя_переменной}` можно встраивать в строки переменные, и вообще любые выражения (в т.ч. функции)

// // второй пример :

// const myName = "TEST"
// const townName = "TEST_TEST"
// const result = `Привет! Меня зовут ${myName}, и я живу в городе ${townName}`
...
// // функциональные выражения всегда анонимные (у них отсутствует имя)
// // функциональное выражение нельзя использовать автономно (т.е. объявить где хочешь и вызвать где хочешь)
// // и фунуцию, и функциональное выражение можно присвоить переменной
// // и фунуцию, и функциональное выражение можно использовать как аргумент в вызове другой функции

// // пример №1:

// const myFnc = function(a,b){ /* myFnc - это просто переменная, которой мы присваиваем значение, которым является функциональное выражение */
//     let c
//     a += 1
//     c = a + b
//     return c
...
// console.log(myFnc(5, 3))

// // пример №2:

// setTimeout(function(){console.log("Отложенное сообщение")}, 1500) /* в данном примере нет смысла давать этой колбек функции имя, проще использовать функциональное выражение */
...
// // стрелочные функции всегда анонимные (имени то нету)))))0)

// // тут мы присваиваем const-переменной стрелочную функцию, с помощью =:

// const myFn = (a, b) => { /* а теперь есть имя)))0) */
//     let c
//     a += 1
//     c = a + b
//     return c
...
// // лучше всего объявлять функции либо с помощью стрелочных функций, либо с помощью функциональных выражений, присваивая их const-переменным
// // потому что в таком случае мы не сможем изменить эту переменную, и функция так и останется функцией


// // стрелочная функция в вызове другой функции:

// setTimeout(() => {console.log("Отложенное сообщение")}, 1000) /* да, стрелочные функции можно использовать как колбек функции */

/* ********************************************************************************сокращения в стрелочных функциях******************************************************************************** */

// 1) если у функции ТОЛЬКО 1 параметр, круглые скобки можно опустить:
// a => {/* ТЕЛО ФУНКЦИИ */}
// 2) фигурные скобки можно опустить, если тело функции состоит из одного выражения: (так же в этом случае функция НЕЯВНО возвращает результат выражения)
// (a, b) => a + b

/* ********************************************************************************значения параметров функции по умолчанию******************************************************************************** */

// // вот тут мы задаём значение по умолчанию параметра muitipl функции myBook с помощью =:

// function myBook(value, muitipl = 1) {
//     return value * muitipl
// }

// // таким образом, мы можем вызвать эту функцию двумя способами:

// console.log(myBook(10, 2))  /* 20 */
// console.log(myBook(7))      /* 7 */
...
//     fnWithError()
// } catch (error) {
//     console.error(error)        /* вывод ошибки целиком */
//     console.log(error.message)  /* вывод только сообщения об ошибке */
// }

// console.log("Continue...")      /* выполнение кода продолжится => увидим Continue... в консоли */

// // рекомендуется ВСЕ блоки кода, в которых потенциально может возникнуть ошибка, запихивать в конструкцию try-catch,
// // для того чтобы приложение не надъебнулось из-за какой-то хуйни

/* ********************************************************************************инструкции******************************************************************************** */

// // Инструкция - это отдельная команда в коде, которая выполняет определённое действие.
// // Инструкции не являются выражениями, но позволяют правильно настроить порядок их выполнения.
// // выражение может быть инструкцией, такое выражение называется Выражение-Инструкция
// // но инструкция не может стать выражением!
// // каждую инструкцию следует завершать ;
// // рекомендуется размещать инструкции на разных строках

// // примеры:

// let a;                          /* инструкция */
// const b = 5;                    /* инструкция */
// a = 6;                          /* а вот это вот вроде как не инструкция, но при этом ей ТАК похуй на ;, шо она есть, шо её нет, поебать вооюще, так и так работает */

// if (a > b) {
//     console.log("а больше!");   /* всё это - инструкция! начиная с if, заканчивая скобками */
// }

// for (let i = 0; i < 5; i++) {   /* инструкция */
//     console.log(i);
// }

// // несмотря на то, что условный оператор и цикл являются инструкциями, они могут и не завершаться ;,
// // но если внутри них одна строка кода (одна инструкция), то ; всё-таки понадобится,
// // т.е. ; не требуется после блока инструкций

// if (a > b) console.log("а больше!");        /* инструкция */

// for (let i = 0; i < 5; i++) console.log(i); /* инструкция */

// // но ; можно опускать)))

// // выражения - инструкции:

// // "abc";                   /* было выражение, добавили ;, стала инструкция */
// // a = a + 3;               /* и тут */
// // c = a + b;               /* и тут */
// // d = "Penis" + "Bolshoi"; /* и тут */
// // myFn(c, d);              /* и тут */
// // console.log("hui");      /* и тут */

// // короче ЛЮБОЕ выражение, после которого стоит ;, является инструкцией
// // как отличить выражение от инструкции? выражения могут быть использованы как аргументы в вызовах функций, а инструкции - нет:
...
// myFn(2 + 3)         /* в качестве аргумента функции передаётся выражение => она отработает корректно */
// myFn(b)             /* и тут */
// myFn(c = c + 1)     /* и тут */
// myFn(c = c + 1;)    /* а вот тут вот ты нахуй пойдёшь, потому что это инструкция))) */
// myFn(let b)         /* тут тоже))) */
...
// // формат записи массивов (способ №1):
// const myArray = [1, 2, 3]
// // способ №2:
...
// // в один массив можно захуярить значения разных типов, ему просто поебать:

// const swagaArray = [1, true, "Pudge", {first: 1, second: "2"}]

// console.log(swagaArray)
// console.log(typeof(swagaArray[3])) /* выведет object */

// по сути, массив и объект вполне себе совподают, но у них разные прототипы => разное поведение
...
// можно вывести значение одного свойства объекта по его названию:
console.log(myObj[2])

// можно добавить новое свойство, используя такой синтаксис:
myObj[5] = "5"

console.log(myObj)

// если свойства у объекта цифровые, то нельзя использовать точечную запись:
